...
const ManageMatches = () => {
  ...
  return (
    <div className="flex flex-col p-8 bg-gradient-to-br from-[#0f0c29] via-[#302b63] to-[#24243e] min-h-screen text-white gap-8">
      {/* Add Match Section */}
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        className="bg-white/10 backdrop-blur-xl rounded-xl p-6 shadow-xl"
      >
        ...
        <form onSubmit={handleAddMatch} className="space-y-4">
          <div>
            <label className="block text-sm mb-1 text-gray-300">Select Arena</label>
            <select
              value={selectedArena}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {matches.map((match, index) => (
              <motion.div
                ...
                className="bg-white/10 backdrop-blur-lg rounded-xl p-4 shadow-lg hover:shadow-[0_0_20px_rgba(34,211,238,0.6)] transition relative"
              >
                <button
